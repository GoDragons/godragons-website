  ...
  return (
    <article className="case-study-hiit-tribe">
      ...
      <BoxedLayout>
        <h3>The Customer</h3>
        <p>
          HIIT Tribe is a wellbeing & fitness startup who are rethinking the way
          people live and exercise. Their goal is to have a positive impact on
          their members’ happiness by fostering a sense of community, and group
          workouts are the first step towards achieving that.
        </p>
        <br />
        <br />
        <img
        ...
        <p>
          HIIT Tribe approached GoDragons when they already had a rough idea of
          how the application should behave, and presented us with wireframes
          for the admin side. This allowed us to have a reasonable idea of the
          functionality required.
        </p>
        <p>
          Given that the success of the project hinged on our ability to find a
          way to keep all the timers and workout videos in sync, we started with
          a proof-of-concept that included this critical part of the work.
        </p>
        ...
        <p>
          ...
          start work on the actual application. This included both the admin and
          “playback” sides, which were developed in parallel. The process was
          iterative, and it was agreed with the client to have a continous
          “demo” process: we used a staging environment, where all new features
          went for client sign-off, before being included in the production
          version. We also had regular meetings every 1-2 weeks (both in-person
          and virtual, depending on our client’s availability) to have more
          in-depth conversations and to interact with the system together.
        </p>
        ...
        <p>
          ...
          taking trips to the gym itself to assess viability, plus communicating
          with the people in charge of building the actual gym site, to make
          sure all the wiring was in place and the network connectivity was
          appropriate.
        </p>
